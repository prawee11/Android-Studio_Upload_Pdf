package com.example.pdf_checking;
...
public class UploadPDF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Uploads44");
    ...
    private void UploadFiles(Uri data) {
        ...
        StorageReference reference = storageReference.child("Uploads234/" + System.currentTimeMillis() + ".pdf");
